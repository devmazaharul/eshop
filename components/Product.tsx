...
export default function Product({title,src,price,discount,rating}:Productprop) {
  ...
  return (
    <div className=' shadow-lg h-[420px] relative shadow-gray-200 rounded-md '>
      <p className='bg-yellow-600 px-4  top-6 relative  rounded-md text-gray-100 font-semibold w-fit'>{discount}% OFF</p>
      <Image src={src} width={400}  height={350} className='rounded-t-md' alt='product images'/>
      <div className='p-2'>
      ...
      <div className='py-2 w-fit gap-3  flex font-semibold items-center justify-around'>
        ...
        <p className=' line-through text-gray-500'>৳ {parseInt(exprice.toString())} </p>
      </div>
